...
export const moduleIndexRoute = new Route({
    ...
    path: '/',
    component: lazyRouteComponent(() => import('@features/course-admin/module/ModuleList.tsx')),
});

export const newModuleRoute = new Route({
    getParentRoute: () => moduleRoute,
    path: 'new',
    component: lazyRouteComponent(() => import('@features/course-admin/module/NewModule.tsx')),
});
...
export const moduleDetailRoute = new Route({
    ...
    path: '$id',
    parseParams: (params) => ({ id: z.number().int().parse(parseInt(params.id)) }),
    component: lazyRouteComponent(() => import('@features/course-admin/module/ModuleDetail.tsx')),
});

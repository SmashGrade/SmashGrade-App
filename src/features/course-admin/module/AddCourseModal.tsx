...
export function AddCourseModal({ modalShown, setModalShown, module }: Readonly<AddCourseModalProps>) {
    const {
        isPending,
        isError,
        data: allCourses,
    ...
    const [courses, setCourses] = useState<number[]>(module.courses.map((course) => course.id));
